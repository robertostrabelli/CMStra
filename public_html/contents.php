...
try {
  ...
  $query = $db->query("SELECT * FROM `contents` WHERE `content_tags` LIKE '%$content_tag%' ORDER BY `id` DESC LIMIT $start , $per_page");
  ...
  $title_page = $SiteByTagTitle .' '. $content_tag;
  ...
  echo "<h1>$SiteByTagTitle $content_tag</h1>";
